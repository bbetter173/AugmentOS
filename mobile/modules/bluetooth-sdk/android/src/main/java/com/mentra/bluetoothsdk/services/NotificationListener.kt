...
class NotificationListener private constructor(private val context: Context) {
    ...
    internal fun onNotificationPosted(sbn: StatusBarNotification) {
        ...
        // Check blocklist
        val blocklist = DeviceStore.get("core", "notifications_blocklist") as? List<String> ?: emptyList()
        ...
        val notificationsEnabled = DeviceStore.get("core", "notifications_enabled") as? Boolean ?: false
