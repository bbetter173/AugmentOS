const en = {
  ...
  settings: {
    ...
    glassesMenuEmpty: "No apps in menu. Tap 'Add App' below.",
    glassesMenuAddApp: "Add App",
    glassesMenuAvailableApps: "Available Apps",
    glassesMenuNoApps: "No more apps available to add.",
    glassesMenuIncompatible: "(incompatible)",
    glassesMenuReset: "Reset to auto (most recently used apps)",
    glassesMenuApps: "Menu Apps",
