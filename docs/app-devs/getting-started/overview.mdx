...
<Info>
This section is for cloud Mini Apps built with `@mentra/sdk`. If you are building a native mobile app that connects directly to glasses over Bluetooth, use the [Bluetooth SDK docs](/bluetooth-sdk/overview).
</Info>
