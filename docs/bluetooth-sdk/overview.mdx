...
- Apps that control model-supported features such as brightness, dashboard position, head-up angle, gallery-button behavior, camera settings, speaker playback, RGB LEDs, Wi-Fi, hotspot, microphone, camera, and streaming.
