...
export default function CameraSettingsScreen() {
  ...
  const handlePhotoSizeChange = (size: PhotoSize) => {
    ...
    setPhotoSize(size)
    BluetoothSdk.updateCore({button_photo_size: size}).catch((error: any) => {
  ...
  const handleVideoResolutionChange = (resolution: VideoResolution) => {
    ...
    BluetoothSdk.updateCore({button_video_width: width, button_video_height: height, button_video_fps: fps}).catch(
      (error: any) => {
  ...
  const handleMaxRecordingTimeChange = (time: MaxRecordingTime) => {
    ...
    BluetoothSdk.updateCore({button_max_recording_time: minutes}).catch((error: any) => {
