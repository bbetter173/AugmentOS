const en = {
  ...
  versionCheck: {
    ...
    updateAvailableDescription: "A newer version of the Mentra app is available. We recommend updating for the best experience.",
    update: "Update",
    ...
    connectionErrorCustomUrl: "Could not connect to the custom server. Please try using the default server or check your connection.",
