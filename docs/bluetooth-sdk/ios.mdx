...
<Warning>
The SDK does not currently create its `CBCentralManager` instances with `CBCentralManagerOptionRestoreIdentifierKey`. Terminated-app Core Bluetooth state restoration is not supported yet. If iOS terminates the app, relaunch the app and reconnect from your normal startup flow.
</Warning>
