...
- **[API Reference](/app-devs/reference/managers/camera)** - Detailed API documentation for all camera methods
...
- **Permissions**: Camera access requires the `CAMERA` permission in your app manifest. See [Permissions Guide](/app-devs/core-concepts/permissions) for setup instructions.
