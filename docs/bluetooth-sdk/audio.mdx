...
<Info>
Your app owns user-facing microphone permission copy. Ask for microphone access only when the feature needs it, and provide a visible way to disable microphone streaming.
</Info>
