...
import {
  ...
  DEFAULT_AUTOMATIC_INCIDENT_DEDUPE_MS,
} from './automaticBugReport'
...
describe('automaticIncidentReportDedupeShouldSkip', () => {
  it('skips duplicates within the dedupe window', () => {
    ...
    expect(automaticIncidentReportDedupeShouldSkip('k', t0, DEFAULT_AUTOMATIC_INCIDENT_DEDUPE_MS, registry)).toBe(
      false,
    )
    expect(
