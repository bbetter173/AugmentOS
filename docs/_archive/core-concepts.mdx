---
title: "Core Concepts"
description: "Learn the fundamental concepts you need to understand to build MentraOS apps for smart glasses."
---
...
The camera module enables visual functionality on camera-equipped smart glasses through the [`CameraManager`](app-devs/reference/managers/camera) (accessible via `session.camera`):
